...
def player_turn(run,draw_X,draw_O,d,m,s1,s2):
    hm = 0
    while hm == 0:
        unplayed = []
...
def ai_turn(d,m,draw_O):


    pos = {(0,0): (220,70), (0,1): (353,70), (0,2): (486,70), (1,0): 
    (220,203), (1,1): (353,203), (1,2): (486,203), (2,0): (220,337), (2,1): (353,337), (2,2): (486,337)}
    ...
    if len(unplayed_positions) > 0: 
        ...
        d[choice] = 1
        m[choice[0]][choice[1]] = 'O'
        pygame.time.delay(1000)
        draw_O.append(pos[choice])
    else: navin = 'hmmm'    
...
def main(s1,s2):
    ...
    while run:
        ...
        player_turn(run,draw_X,draw_O,d,m,s1,s2)
        if winner(m) == 'X':
            s1 += 1
            print_winner(m) 
            break   
